<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM007B.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Common.FRM007B" %>
...
<body>
   <form id="form1" runat="server">
    <x:PageManager ID="PageManager1" AutoSizePanelID="Panel5" runat="server" />
        ...
        <x:Window ID="winEdit" Title="Nuevos Permisos por Almacén / Organización" Popup="false" EnableIFrame="true" runat="server" Icon="UserBrown"
