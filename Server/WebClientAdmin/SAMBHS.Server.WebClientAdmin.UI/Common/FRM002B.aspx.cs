...
namespace SAMBHS.Server.WebClientAdmin.UI.Common
{
    public partial class FRM002B : System.Web.UI.Page
    {
        ...
        //    {
        //        LoadData();
        //        btnNew.OnClientClick = winEdit.GetSaveStateReference(hfRefresh.ClientID) + winEdit.GetShowReference(string.Format("FRM002A.aspx?Mode=NewChildren&i_GroupId={0}", txtParameterId.Text));
