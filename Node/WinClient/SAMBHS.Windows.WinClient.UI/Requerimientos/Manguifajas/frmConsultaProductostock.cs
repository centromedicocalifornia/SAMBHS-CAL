...
namespace SAMBHS.Windows.WinClient.UI.Requerimientos.Manguifajas
{
    public partial class frmConsultaProductostock : Form
    {
     ...
     private void OcultarMostrarBuscar(bool estado)
        ...
        {
            string _CodigoInterno = grdData.Rows[grdData.ActiveRow.Index].Cells["v_CodInterno"].Value.ToString().Trim();

            var frmEditarPrecio = new frmEditarStock(_CodigoInterno);
