...
{
    public partial class frmComprasLineaResumen : Form
    {
        ...
        public frmComprasLineaResumen(string Modalidad)
        {
            InitializeComponent();
        ...
        private void frmComprasLineaResumen_Load(object sender, EventArgs e)
        {
        ...
        {
            Text = estado
                ? @"Generando... " + "Reporte de Compras por Linea - Resumen"
                : @"Reporte de Compras por Linea - Resumen";
        ...
        private void CargarReporte(DateTime FechaInicio, DateTime FechaFin, string Filtro, string Agrupar, string Ordenar)
        {
            ...
            var rp = new Reportes.Compras.crComprasGastosResumen();
            ...
            aptitudeCertificate = new ComprasBL().ReporteComprasLinea(ref objOperationResult, FechaInicio, FechaFin, Filtro, Agrupar, Ordenar, strGrupollave, "RESUMEN", ConsideraDocumentosInternos,false);
            ...
            .ContinueWith(t =>
            {
                ...
                if (objOperationResult.Success == 0)
                {
                    ...
                    {
                        UltraMessageBox.Show("Ocurrió un Error al realizar Reporte de Compras por Linea - Resumen","Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        UltraMessageBox.Show("Ocurrió un Error al realizar Reporte de Compras por Linea - Resumen","Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void frmComprasLineaResumen_FormClosing(object sender, FormClosingEventArgs e)
        {
