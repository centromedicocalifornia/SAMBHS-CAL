...
{
    [DataContract()]
    public partial class extendedactionDto
    {
        [DataMember()]
        public Int32 i_ExtendedActionId { get; set; }
        ...
        public extendedactionDto()
        {
        }

        public extendedactionDto(Int32 i_ExtendedActionId, Nullable<Int32> i_SystemUserId, Nullable<Int32> i_ApplicationHierarchyId, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, applicationhierarchyDto applicationhierarchy, systemuserDto systemuser)
        {
			this.i_ExtendedActionId = i_ExtendedActionId;
