...
namespace SAMBHS.Common.BE
{
    ...
    {
        [DataMember()]
        public String v_IdPlanillaVariablesIngresos { get; set; }
        ...
        public planillavariablesingresosDto()
        {
        }

        public planillavariablesingresosDto(String v_IdPlanillaVariablesIngresos, String v_IdPlanillaVariablesTrabajador, String v_IdConceptoPlanilla, Nullable<Decimal> d_Importe, Nullable<Int32> i_IdMoneda, Nullable<Int32> i_Eliminado, Nullable<Int32> i_InsertaIdUsuario, Nullable<DateTime> t_InsertaFecha, Nullable<Int32> i_ActualizaIdUsuario, Nullable<DateTime> t_ActualizaFecha, planillavariablestrabajadorDto planillavariablestrabajador)
        {
			this.v_IdPlanillaVariablesIngresos = v_IdPlanillaVariablesIngresos;
