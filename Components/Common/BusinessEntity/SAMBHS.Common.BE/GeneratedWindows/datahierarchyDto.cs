...
namespace SAMBHS.Common.BE
{
    ...
    public partial class datahierarchyDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_SyncStatusId { get; set; }

        [DataMember()]
        public Nullable<Int32> i_RecordStatusId { get; set; }
        ...
        public datahierarchyDto(Int32 i_GroupId, Int32 i_ItemId, String v_Value1, String v_Value2, String v_Field, Nullable<Int32> i_ParentItemId, Nullable<Int32> i_Header, Nullable<Int32> i_Sort, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_SyncStatusId, Nullable<Int32> i_RecordStatusId, String v_Value4)
        {
			...
			this.i_SyncStatusId = i_SyncStatusId;
			this.i_RecordStatusId = i_RecordStatusId;
			this.v_Value4 = v_Value4;
        }
    }
}
