<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM005.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Security.FRM005" %>
...
<body>
   <form id="form1" runat="server">      
    <x:Pagemanager ID="PageManager1" runat="server" AutoSizePanelID="Panel1"/>
     <x:Panel ID="Panel1" runat="server"  ShowBorder="True" ShowHeader="True" Title="Administración de Menú" EnableBackgroundColor="true" Layout="VBox" 
                ...
                <Toolbars>
                    <x:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                            ...
                            <x:TextBox ID="txtBuscar" Label="Buscar:" runat ="server"></x:TextBox>
                        </Items>
                    </x:Toolbar>
                </Toolbars>
                <Columns>                   
                    <x:WindowField ColumnID="myWindowField" Width="25px" WindowID="winEdit" HeaderText=""
                        ...
                        DataIFrameUrlFields="i_ApplicationHierarchyId" DataIFrameUrlFormatString="FRM005A.aspx?Mode=Edit&i_ApplicationHierarchyId={0}" 
                        DataWindowTitleField="v_Value1" DataWindowTitleFormatString="Editar Menú {0}" />
