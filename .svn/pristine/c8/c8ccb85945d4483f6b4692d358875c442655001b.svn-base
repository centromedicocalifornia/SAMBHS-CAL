...
{
    public partial class frmRegistroCompraAnaliticoDAOT : Form
    {

        private readonly CancellationTokenSource _cts = new CancellationTokenSource();
        ComprasBL _objComprasBL = new ComprasBL();
        public frmRegistroCompraAnaliticoDAOT(string parametro)
        {
            InitializeComponent();
        }

        private void frmRegistroCompraAnaliticoDAOT_Load(object sender, EventArgs e)
        {
        ...
        {
            Text = estado
                ? @"Generando... " + "Reporte de Compras Proveedor DAOT Analítico"
                : @"Reporte de Compras Proveedor DAOT Analítico";
      ...
      //  http://www.excelnegocios.com/estructuras-txt-para-importar-a-pdt-3500-operaciones-con-terceros-daot/
            ...
            .ContinueWith(t =>
            {
                ...
                if (objOperationResult.Success == 0)
                {
                    ...
                    {
                        UltraMessageBox.Show("Ocurrió un Error al generar Reporte de Compras Proveedor DAOT Analítico", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        UltraMessageBox.Show("Ocurrió un Error al generar Reporte de Compras Proveedor DAOT Analítico", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                var rp = new Reportes.Compras.crReporteComprasDaotAnalitico();
        ...
        {
            Utils.Windows.NumeroEnteroUltraTextBox(txtTope, e);
