...
namespace SAMBHS.Common.BE
{
    ...
    public partial class planillarelacioningresosDto
    {
        ...
        public planillarelacioningresosDto()
        {
        }

        public planillarelacioningresosDto(Int32 i_Id, String v_Periodo, Nullable<Int32> i_IdTipoPlanilla, String v_IdConceptoPlanilla, Nullable<Int32> i_IdCentroCosto, String v_NroCuenta, Nullable<Int32> i_Eliminado, Nullable<Int32> i_InsertaIdUsuario, Nullable<DateTime> t_InsertaFecha, Nullable<Int32> i_ActualizaIdUsuario, Nullable<DateTime> t_ActualizaFecha, planillaconceptosDto planillaconceptos)
        {
			this.i_Id = i_Id;
