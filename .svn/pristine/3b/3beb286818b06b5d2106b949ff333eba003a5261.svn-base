...
namespace SAMBHS.Common.BE
{
    ...
    public partial class planillarelacionesaportacionesDto
    {
        ...
        [DataMember()]
        public String v_NroCuenta_A { get; set; }

        [DataMember()]
        public String v_NroCuenta_B { get; set; }
        ...
        public planillarelacionesaportacionesDto()
        {
        }

        public planillarelacionesaportacionesDto(Int32 i_Id, String v_Periodo, Nullable<Int32> i_IdTipoPlanilla, String v_IdConceptoPlanilla, Nullable<Int32> i_IdCentroCosto, String v_NroCuenta_A, String v_NroCuenta_B, Nullable<Int32> i_Eliminado, Nullable<Int32> i_InsertaIdUsuario, Nullable<DateTime> t_InsertaFecha, Nullable<Int32> i_ActualizaIdUsuario, Nullable<DateTime> t_ActualizaFecha, planillaconceptosDto planillaconceptos)
        {
			this.i_Id = i_Id;
			...
			this.v_NroCuenta_A = v_NroCuenta_A;
			this.v_NroCuenta_B = v_NroCuenta_B;
