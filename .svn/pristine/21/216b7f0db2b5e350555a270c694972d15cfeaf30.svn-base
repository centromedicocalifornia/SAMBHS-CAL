<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM002.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Common.FRM002" %>
            ...
            EnableTextSelection="true" EnableAlternateRowColor="true" BoxFlex="2" BoxMargin="5" OnRowCommand="grdData_RowCommand" OnPreRowDataBound="grdData_PreRowDataBound">
                ...
                <Columns>
                    <x:WindowField ColumnID="myWindowField" Width="25px" WindowID="winEdit" HeaderText=""
                        ...
                        DataIFrameUrlFields="i_GroupId,i_ItemId" DataIFrameUrlFormatString="FRM002A.aspx?Mode=Edit&i_GroupId={0}&i_ItemId={1}" 
                    ...
                    <x:WindowField ColumnID="myWindowFieldChildren" Width="25px" WindowID="winViewChildren" HeaderText=""
                        ...
                        DataIFrameUrlFields="i_GroupId,i_ItemId" DataIFrameUrlFormatString="FRM002B.aspx?Mode=Edit&i_GroupId={0}&i_ItemId={1}" 
