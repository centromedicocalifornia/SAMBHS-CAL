...
{
    public partial class frmRegistroVentaProductoResumenUtilidad : Form
    {
        ...
        public frmRegistroVentaProductoResumenUtilidad(string Modalidad)
        {
            InitializeComponent();
        ...
        private void CargarReporte(DateTime FechaRegistroIni, DateTime FechaRegistroFin, int IdMoneda, string FechaHoraImpresion, string IdCliente, string IdProducto, string Orden, int pIntEstablecimiento, string strAlmacenes, string IdLinea, bool export)
        {
            ...
            .ContinueWith(t =>
            {
                ...
                if (export)
                {
                    ...
                    var cols = cboAgrupar.Text == "SIN AGRUPAR" ? cboEstablecimiento.Value == "-1" ? new List<string> { "IdProducto", "NombreProducto", "CantidadDetalle", "CostoUnitario", "CostoTotal", "ValorVentaDetalle", "Utilidad", "MargenContribucion", "PrecioVtaUnitarioPromedio", "NombreMoneda" } : new List<string> { "v_Almacen", "IdProducto", "NombreProducto", "CantidadDetalle", "CostoUnitario", "CostoTotal", "ValorVentaDetalle", "Utilidad", "MargenContribucion", "PrecioVtaUnitarioPromedio", "NombreMoneda" } : cboEstablecimiento.Value == "-1" ? new List<string> { "IdProducto", "NombreProducto", "CantidadDetalle", "CostoUnitario", "CostoTotal", "ValorVentaDetalle", "Utilidad", "MargenContribucion", "PrecioVtaUnitarioPromedio", "NombreMoneda", "GrupoLLave" } : new List<string> { "v_Almacen", "IdProducto", "NombreProducto", "CantidadDetalle", "CostoUnitario", "CostoTotal", "ValorVentaDetalle", "Utilidad", "MargenContribucion", "PrecioVtaUnitarioPromedio", "NombreMoneda", "GrupoLLave" };
                    var heads = cboAgrupar.Text == "SIN AGRUPAR" ? cboEstablecimiento.Value == "-1" ? new List<ExcelHeader> { "CODIGO", "DESCRIPCION", "CANTIDAD", "COSTO UNITARIO S/.", "COSTO TOTAL", "VALOR VENTA", "UTILIDAD", "MARGEN CONTRIBUCIÓN", "PRECIO UNITARIO PROMEDIO", "MONEDA" } : new List<ExcelHeader> { "ALMACÉN", "CODIGO", "DESCRIPCION", "CANTIDAD", "COSTO UNITARIO S/.", "COSTO TOTAL", "VALOR VENTA", "UTILIDAD", "MARGEN CONTRIBUCIÓN", "PRECIO UNITARIO PROMEDIO", "MONEDA" } : cboEstablecimiento.Value == "-1" ? new List<ExcelHeader> { "CODIGO", "DESCRIPCION", "CANTIDAD", "COSTO UNITARIO S/.", "COSTO TOTAL", "VALOR VENTA", "UTILIDAD", "MARGEN CONTRIBUCIÓN", "PRECIO UNITARIO PROMEDIO", "MONEDA", "AGRUPAMIENTO" } : new List<ExcelHeader> { "ALMACEN", "CODIGO", "DESCRIPCION", "CANTIDAD", "COSTO UNITARIO S/.", "COSTO TOTAL", "VALOR VENTA", "UTILIDAD", "MARGEN CONTRIBUCIÓN", "PRECIO UNITARIO PROMEDIO", "MONEDA", "AGRUPAMIENTO" };
                ...
                else
                {
                    ...
                    using (DataSet ds1 = new DataSet())
                    {
                        ...
                        var rp = new crRegistroVentaProductoResumenUtilidad();
