...
namespace SAMBHS.Windows.WinClient.UI.Reportes.Compras
{
    public partial class frmCondicionPago : Form
    {
        ...
        public frmCondicionPago( string parameter)
        {
            InitializeComponent();
        }
        #endregion
        ...
        private void CargarReporte()
        {
            ...
            var rp = new Reportes.Compras.crCondicionPago();


            var aptitudeCertificate = new DatahierarchyBL().ReporteDataHierarchy("", 23);
