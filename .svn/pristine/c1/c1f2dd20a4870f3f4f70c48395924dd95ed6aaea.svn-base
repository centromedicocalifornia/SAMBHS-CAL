<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM001.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Common.FRM001" %>
...
<body>
    ...
    <x:Pagemanager ID="PageManager1" runat="server" AutoSizePanelID="Panel1"/>
     <x:Panel ID="Panel1" runat="server"  ShowBorder="True" ShowHeader="True" Title="Administración Parámetros del Sistema" EnableBackgroundColor="true" Layout="VBox" 
                        ...
                        <Items>                             
                            <x:Panel ID="Panel133" ShowHeader="false" CssClass="x-form-item" ShowBorder="false" EnableBackgroundColor="true" Layout="Column"  runat="server">
                                <Items>
                                    ...
                                    <x:LinkButton ID="link" runat="server" Text="bajar" OnClick="link_Click"></x:LinkButton>
                                </Items>
                            </x:Panel> 
                        </Items> 
                    </x:SimpleForm>
 ...
 <x:Window ID="winEdit" Title="Nuevo Grupo / Parámetro" Popup="false" EnableIFrame="true" runat="server" Icon="UserBrown"
        ...
        Target="Top" OnClose="winEdit_Close" IsModal="True" Width="450px" Height="333px" >
    </x:Window>
