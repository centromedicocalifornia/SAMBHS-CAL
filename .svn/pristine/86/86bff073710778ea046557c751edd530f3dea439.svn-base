...
{
    [DataContract()]
    public partial class planillaafecrentquintaDto
    {
        [DataMember()]
        ...
        [DataMember()]
        public Nullable<Int32> i_Afecto { get; set; }
        ...
        public planillaafecrentquintaDto()
        {
        }

        public planillaafecrentquintaDto(Int32 i_Id, String v_Periodo, String v_Mes, String v_IdConceptoPlanilla, Nullable<Int32> i_Afecto, Nullable<Int32> i_Eliminado, Nullable<DateTime> t_InsertaFecha, Nullable<Int32> i_InsertaIdUsuario, Nullable<DateTime> t_ActualizaFecha, Nullable<Int32> i_ActualizaIdUsuario)
        {
			this.i_Id = i_Id;
			this.v_Periodo = v_Periodo;
			this.v_Mes = v_Mes;
			this.v_IdConceptoPlanilla = v_IdConceptoPlanilla;
			this.i_Afecto = i_Afecto;
