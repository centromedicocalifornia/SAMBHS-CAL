...
{
    public partial class frmMigracionVentas : Form
    {
        ...
        public frmMigracionVentas(string N)
        {
            InitializeComponent();
        }
        ...
        private void btnImportarCabecera_Click(object sender, EventArgs e)
        {
            ...
            cboCabCodCliente.SelectedIndex = Columnas.FindIndex(p => p == "RUC_3");
                    ...
                    try
                    {
                        ...
                        foreach (var Fila in BoletasYFacturas)
                        {
                            ...
                            try
                            {
                                ...
                                venta.i_IdTipoDocumento = int.Parse(Fila.Cells[cboCabTipoDoc.Text].Value.ToString().Trim());
                                ...
                                venta.i_IdTipoDocumentoRef = !string.IsNullOrEmpty(Fila.Cells[cboCabTipoDocRef.Text].Value.ToString().Trim()) ? int.Parse(Fila.Cells[cboCabTipoDocRef.Text].Value.ToString().Trim()) : -1;
                                ...
                                venta.i_IdEstado = int.Parse(Fila.Cells[cboCabEstado.Text].Value.ToString().Trim());
                                ...
                                if (venta.i_IdEstado == 1)
                                {
                                    ...
                                    {
                                        KeyValueDTO Cliente = Clientes.FirstOrDefault(p => p.Value5.Trim() == codCliente);
                                ...
                                venta.i_NroDias = int.Parse(Fila.Cells[cboCabNroDias.Text].Value.ToString());

                                venta.t_FechaVencimiento = venta.t_FechaRegistro.Value.AddDays(venta.i_NroDias.Value);

                                venta.i_IdCondicionPago = Fila.Cells[cboCabCondPago.Text].Value != null ? int.Parse(Fila.Cells[cboCabCondPago.Text].Value.ToString()) : -1;

                                venta.i_EsAfectoIgv = int.Parse(Fila.Cells[cboCabAfectoIGV.Text].Value.ToString());
                                venta.i_PreciosIncluyenIgv = int.Parse(Fila.Cells[cboCabIncluyeIGV.Text].Value.ToString());
                                ...
                                venta.d_Anticipio = 0;
                                venta.i_DeduccionAnticipio = !string.IsNullOrWhiteSpace(cboCabDeduccionAnticipo.Text) ? int.Parse(Fila.Cells[cboCabDeduccionAnticipo.Text].Value.ToString()) : 0;
                                ...
                                venta.i_IdTipoVenta = int.Parse(Fila.Cells[cboCabTipoVenta.Text].Value.ToString().Trim());
                                ...
                                if ((listBox1.Items.Count > 0 && listBox2.Items.Count > 0) && (listBox1.Items.Count == listBox2.Items.Count))
                                {
                                    ...
                                    {
                                        var valorExcel = int.Parse(Fila.Cells[cboCabTipoOperacion.Text].Value.ToString().Trim());
                                ...
                                venta.i_IdMoneda = Int32.Parse(Fila.Cells[cboCabMoneda.Text].Value.ToString().Trim()); ;
                        ...
                        foreach (var Fila in detallesBoletasYFacturas)
                        {
                            ...
                            var ventadetalle = new ventadetalleDto
                            {
                                ...
                                v_NroCuenta = Fila.Cells[cboDetNroCuenta.Text].Value.ToString().Trim(),
                                i_Anticipio = !string.IsNullOrWhiteSpace(cboDetEsAnticipo.Text.Trim()) ? int.Parse(Fila.Cells[cboDetEsAnticipo.Text].Value.ToString()) : 0
                            };
                            ...
                            ventadetalle.d_Cantidad = cantidad;
        ...
        private static DateTime RetornaFecha(string pstrFecha)
        {
            try
            {
                ...
                {
                    DateTime fecha;
                    return DateTime.TryParse(pstrFecha, out fecha) ? fecha : DateTime.FromOADate(double.Parse(pstrFecha));
                }
