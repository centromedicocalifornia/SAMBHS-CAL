...
{
    public partial class frmComprasGastosResumen : Form
    {
        ...
        public frmComprasGastosResumen(string Modalidad)
        {
            InitializeComponent();
            ConsideraDocumentosInternos = Modalidad == Constants.ModuloContable ? 0 : 1;
        }
        private void frmComprasGastosResumen_Load(object sender, EventArgs e)
        {
        ...
        private void CargarReporte(DateTime FechaInicio, DateTime FechaFin, string Filtro, string Agrupar, string Ordenar)
        {
            ...
            var rp = new Reportes.Compras.crComprasLineaResumen();
            ...
            Task.Factory.StartNew(() =>
            {
                ...
                aptitudeCertificate = new ComprasBL().ReporteComprasLinea(ref objOperationResult, FechaInicio, FechaFin, Filtro, Agrupar, Ordenar, strGrupollave, "RESUMEN", ConsideraDocumentosInternos, true);
            ...
            rp.SetParameterValue ("Establecimiento","" );
