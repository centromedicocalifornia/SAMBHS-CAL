...
namespace SAMBHS.Common.BE
{
    ...
    public partial class planillaafecleyestrabDto
    {
        ...
        [DataMember()]
        public Nullable<Int32> i_SCTRP { get; set; }
