<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM008A.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Common.FRM008A" %>
                                ...
                                <x:Form ID="Form2" runat="server" EnableBackgroundColor="true" ShowBorder="False" ShowHeader="False"
                                    ...
                                    <Rows>
                                        <x:FormRow ID="FormRow1" runat="server">
                                            <Items>
                                                <x:TextBox ID="txtName" Label="Razón Social" Required="true" ShowRedStar="true" runat="server" TabIndex="1" MaxLength="250" 
                                                    MaxLengthMessage="El número máximo de caracteres permitidos es 250" CssClass="mayus"/>                                              
                                            </Items>
                                        </x:FormRow>
                                        <x:FormRow ID="FormRow2" runat="server">
                                            <Items>
                                                <x:NumberBox ID="txtIdentificationNumber" Label="Ruc" Required="true" ShowRedStar="true" runat="server" TabIndex="1" NoDecimal="True" NoNegative="True" MaxLength="11" />
                                                                                             
                                            </Items>
                                        </x:FormRow>
                                        <x:FormRow ID="FormRow3" runat="server">
                                            <Items>
                                                <x:TextBox ID="txtAddress" Label="Dirección" Required="false" runat="server" TabIndex="3" MaxLength="250" 
                                                    MaxLengthMessage="El número máximo de caracteres permitidos es 250" CssClass="mayus" />                                            
                                            </Items>
                                        </x:FormRow>
                                         <x:FormRow ID="FormRow5" runat="server">
                                            ...
                                            <Items>
                                                <x:TextBox ID="txtMail" Label="Mail" Required="false" runat="server" TabIndex="3" MaxLength="200" 
                                                    MaxLengthMessage="El número máximo de caracteres permitidos es 200" CssClass="mayus" />                                            
                                            </Items>
                                        </x:FormRow>
                                             <x:FormRow ID="FormRow7" runat="server">
                                            <Items>
                                                <x:TextBox ID="txtContacName" Label="Contacto" Required="false" runat="server" TabIndex="3" MaxLength="250" 
                                                    MaxLengthMessage="El número máximo de caracteres permitidos es 250" CssClass="mayus" />                                            
                                            </Items>
                                        </x:FormRow>
