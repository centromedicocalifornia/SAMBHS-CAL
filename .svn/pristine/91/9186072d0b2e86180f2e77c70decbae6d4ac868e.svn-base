...
{
    [DataContract()]
    public partial class cobranzapendienteDto
    {
        [DataMember()]
        ...
        public cobranzapendienteDto(String v_IdCobranzaPendiente, String v_IdVenta, Nullable<Decimal> d_Acuenta, Nullable<Decimal> d_Saldo, Nullable<Int32> i_Eliminado, Nullable<Int32> i_InsertaIdUsuario, Nullable<DateTime> t_InsertaFecha, Nullable<Int32> i_ActualizaIdUsuario, Nullable<DateTime> t_ActualizaFecha, ventaDto venta)
        {
			this.v_IdCobranzaPendiente = v_IdCobranzaPendiente;
