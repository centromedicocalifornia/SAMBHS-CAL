...
{
    public partial class frmReporteTipoActivo : Form
    {
        DatahierarchyBL _objDatahierarchyBL = new DatahierarchyBL();
         CancellationTokenSource _cts = new CancellationTokenSource();
        public frmReporteTipoActivo(string pstrParametro)
        {
            InitializeComponent();
        }
        ...
        {
            Text = estado
                ? @"Generando... " + "Reporte de Tipos  de Activo"
                : @"Reporte de Tipos  de Activo";
           ...
           List<datahierarchyDto> aptitudeCertificate = new List<datahierarchyDto>();
            ...
            .ContinueWith(t =>
            {
                ...
                if (objOperationResult.Success == 0)
                {
                    ...
                    {
                        UltraMessageBox.Show("Ocurrió un error al realizar Reporte de Tipos  de Activo", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    else
                    {
                        UltraMessageBox.Show("Ocurrió un error al realizar Reporte de Tipos  de Activo", "Sistema", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void frmReporteTipoActivo_Load(object sender, EventArgs e)
        {
            this.BackColor = new GlobalFormColors().FormColor;
        }

        private void frmReporteTipoActivo_FormClosing(object sender, FormClosingEventArgs e)
        {
