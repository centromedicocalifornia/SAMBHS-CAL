...
namespace SAMBHS.Server.WebClientAdmin.UI.Security
{
    public partial class FRM005A : System.Web.UI.Page
    {
        ...
        private void LoadData()
        {
            ...
            Utils.Web.LoadDropDownList(ddlApplicationHierarchyTypeId, "Value1", "Id", _objProxyCommon.GetSystemParameterForCombo(ref objOperationResultCommon, 106), DropDownListAction.Select);
            Utils.Web.LoadDropDownList(ddlScopeId, "Value1", "Id", _objProxyCommon.GetSystemParameterForCombo(ref objOperationResultCommon, 104), DropDownListAction.Select);
            Utils.Web.LoadDropDownList(ddlTypeFormId, "Value1", "Id", _objProxyCommon.GetSystemParameterForCombo(ref objOperationResultCommon, 116), DropDownListAction.Select);
            Utils.Web.LoadDropDownList(ddlBusinessRule, "Value1", "Id", _objProxyCommon.GetSystemParameterForCombo(ref objOperationResultCommon, 108), DropDownListAction.Select);
            ...
            else if (Mode == "Edit")
            {
                ...
                txtLevel.Text = objEntity.i_Level.ToString();
            }
        }
        ...
        protected void btnSaveRefresh_Click(object sender, EventArgs e)
        {
            ...
            if (Mode == "New")
            {
                ...
                objEntity.i_Level = !string.IsNullOrEmpty(txtLevel.Text.Trim()) ? int.Parse(txtLevel.Text.Trim()) : 0;
                // Save the data                  
