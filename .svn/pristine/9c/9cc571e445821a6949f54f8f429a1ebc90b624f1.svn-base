<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM004B.aspx.cs" Inherits="SAMBHS.Server.WebClientAdmin.UI.Common.FRM004B" %>
                        ...
                        <x:GroupPanel runat="server" Title="Almacenes asignados" ID="GroupPanel1" EnableBackgroundColor="True" AutoWidth="true">
                            <Items>
                               <x:Grid ID="grdData" ShowBorder="false" ShowHeader="false" Title="Almacenes" runat="server"
                                    ...
                                    EnableMouseOverColor="true" ShowGridHeader="true" OnRowCommand="grdData_RowCommand" DataKeyNames="i_NodeWarehouseId"
