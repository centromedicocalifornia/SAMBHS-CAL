...
{
    public partial class frmComprasGastosAnalitico : Form
    {
        ...
        public frmComprasGastosAnalitico(string Modalidad)
        {
            InitializeComponent();
            ConsideraDocumentosInternos = Modalidad == Constants.ModuloContable ? 0 : 1;
        }
        private void frmComprasGastosAnalitico_Load(object sender, EventArgs e)
        {
        ...
        private void CargarReporte(DateTime FechaInicio, DateTime FechaFin, string Filtro, string Agrupar, string Ordenar)
        {
            ...
            {
                aptitudeCertificate = new ComprasBL().ReporteComprasLinea(ref objOperationResult, FechaInicio, FechaFin, Filtro, Agrupar, Ordenar, strGrupollave, "ANALITICO", ConsideraDocumentosInternos,true);
