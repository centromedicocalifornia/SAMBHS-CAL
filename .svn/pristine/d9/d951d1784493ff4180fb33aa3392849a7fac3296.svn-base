...
{
    public partial class frmReporteComprobanteEgreso : Form
    {
        DatahierarchyBL _objDatahierarchyBL = new DatahierarchyBL();
        List<GridKeyValueDTO> _ListadoComboDocumentos = new List<GridKeyValueDTO>();
        DocumentoBL _objDocumentoBL = new DocumentoBL();
        CancellationTokenSource _cts = new CancellationTokenSource();
        public frmReporteComprobanteEgreso(string pstrParameter)
        {
            InitializeComponent();
        }

        private void frmReporteComprobanteEgreso_Load(object sender, EventArgs e)
        {
        ...
        private void CargarCombos()
        {
            ...
            Utils.Windows.LoadUltraComboEditorList (cboBancos, "Value1", "Id", _objDatahierarchyBL.GetDataHierarchiesForCombo(ref objOperationResult, 100, null), DropDownListAction.Select);
        ...
        private void btnVisualizar_Click(object sender, EventArgs e)
        {
            ...
            if (chkCheques.Checked == true)
            {
                if (int.Parse(cboBancos.Value.ToString()) == -1)
                {
                    UltraMessageBox.Show("Seleccionar el Formato del  Banco ", "Error de Validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    cboBancos.Focus();
                    return;
            ...
            int Orden = chkCheques.Checked == true ? 1 : 0;
        ...
        {
            Text = estado
                ? @"Generando... " + "Reporte de Comprobantes de  Egresos"
        ...
        private void CargarReporte(int pIntTipoMovimiento, string pstrPeriodo, int pIntTipoDocumento, int DocInicial, int DocFinal, int Orden)
        {
            ...
            if (chkCheques.Checked == true)
            {
                var rp = new Reportes.Tesoreria.crImpresionCheques();
                ...
                .ContinueWith(t =>
                {
                    ...
                    if (objOperationResult.Success == 0)
                    {
                        ...
                        {
                            UltraMessageBox.Show(objOperationResult.ExceptionMessage + "\n\nTARGET: " + objOperationResult.AdditionalInformation, "Error " + " Reporte de Comprobantes de  Egresos", MessageBoxButtons.OK, MessageBoxIcon.Error);
                        }
                        else
                        {
            ...
            {
                var rp = new Reportes.Tesoreria.crReporteListadoComprobantesTesoreria();
        ...
        private void frmReporteComprobanteEgreso_FormClosing(object sender, FormClosingEventArgs e)
        {
