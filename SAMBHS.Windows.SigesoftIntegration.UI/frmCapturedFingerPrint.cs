...
namespace Sigesoft.Node.WinClient.UI
{
    public partial class frmCapturedFingerPrint : Form
    {
        ...
        private EnumsSigesoft.ModoCargaImagen _modoCargaImagen;
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ZKFPEngX1.GetTemplate().ToString() != string.Empty)
                {
                    ...
                    FingerPrintImage = UtilsSigesoft.byteArrayToByteArrayImageJpg((byte[])image);
                    //***********************************************************************

                }
                else
                {
                    if (_modoCargaImagen == EnumsSigesoft.ModoCargaImagen.DesdeArchivo)
                    {
                        FingerPrintImage = UtilsSigesoft.ImageToByteArrayImageJpg1(pbFingerPrint.Image);
                    }
                ...
                RubricImage = UtilsSigesoft.ImageToByteArrayImageJpg(myimage);
        ...
        private void frmCapturedFingerPrint_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                else if (Mode == "Edit")
                {
                    ...
                    pbFingerPrint.Image = UtilsSigesoft.byteArrayToImage(FingerPrintImage);
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            _modoCargaImagen = EnumsSigesoft.ModoCargaImagen.DesdeArchivo;
