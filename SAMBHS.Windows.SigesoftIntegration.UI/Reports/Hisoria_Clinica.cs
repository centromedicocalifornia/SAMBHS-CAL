...
namespace NetPdf
{
    public class Hisoria_Clinica
    {
        ...
        public static void CreateHistoria_Clinica(string filePDF, OrganizationDto1 infoEmpresaPropietaria,
            PacientList datosPac, MedicoTratanteAtenciones medico, int edad, string edadCompleta)
        {
            ...
            //    imagenEmpresa.SetAbsolutePosition(50, 780);
            ...
            var cellsTit = new List<PdfPCell>()
                {
                     new PdfPCell(new Phrase("F.H.: "+datosPac.FechaServicio.ToString() , fontTitle1_2)) {HorizontalAlignment = iTextSharp.text.Element.ALIGN_RIGHT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = 12f},
            ...
            cells = new List<PdfPCell>()
                {
                    ...
                    new PdfPCell(new Phrase("CIE 10", fontColumnValueBold)) {Colspan=1, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, FixedHeight = tamaño_celda},       

                    new PdfPCell(new Phrase("1. ", fontColumnValue)) {Colspan=3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=15f },
                    new PdfPCell(new Phrase("2. ", fontColumnValue)) {Colspan=3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=15f },
                    new PdfPCell(new Phrase("3. ", fontColumnValue)) {Colspan=3, HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT,VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight=15f },
