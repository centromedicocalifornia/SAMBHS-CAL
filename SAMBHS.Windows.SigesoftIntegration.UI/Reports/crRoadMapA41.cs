...
namespace SAMBHS.Windows.SigesoftIntegration.UI.Reports {
    ...
    public class crRoadMapA4 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "SAMBHS.Windows.SigesoftIntegration.UI.Reports.crRoadMapA4.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedcrRoadMapA4 : Component, ICachedReport {
        
        public CachedcrRoadMapA4() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            crRoadMapA4 rpt = new crRoadMapA4();
            rpt.Site = this.Site;
            return rpt;
        }
